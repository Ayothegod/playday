    ...
    <main className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Find your next game</p>
        </div>
        ...
        <Card className="bg-card border-border/50 p-6 md:p-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Join thousands of players finding their next game
            </p>
          </div>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full h-12 gap-3 mb-4 group cursor-pointer"
          >
